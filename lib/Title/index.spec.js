...
describe('Title', () => {
  ...
  describe('default', () => {
    it('tag and type', () => {
      const elem = shallow(<Title>Title text</Title>);
  ...
  describe('props', () => {
    it('type', () => {
      const elem = shallow(<Title type="h2">Title text</Title>);
      expect(elem.find(`.${styles.h2}`)).to.have.length(1);
    });

    it('tag', () => {
      const elem = shallow(<Title tag="h2">Title text</Title>);
      expect(elem.find('h2')).to.have.length(1);
    });

    it('tag and type', () => {
      const elem = shallow(<Title type="h1" tag="h2">Title text</Title>);
      expect(elem.find('h2')).to.have.length(1);
      expect(elem.find(`.${styles.h1}`)).to.have.length(1);
    });
  });
